...
Last updated: 2026-09-01 (R3 Mix Check redesign PROMOTED & LIVE on `main` @ `dbc793d`; post-ship fix round pending from Kevin — see `docs/HANDOVER.md` top entry)
