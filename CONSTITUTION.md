...
Scope   : AIMM personal domain — all personal repositories under begb0037admin
...
is conducted across AIMM and personal repositories. It is not a
...
This constitution applies to every personal repository, every
project, and every session within the personal domain regardless
of technology stack, workflow, or tooling.
...
| Version | Date       | Change                                     |
|---------|------------|--------------------------------------------|
| 1.0     | 2026-06-29 | Initial ratification for AIMM personal     |
|         |            | domain. Mirrors work CONSTITUTION.md v2.0  |
|         |            | principles. Personal domain scope only.    |
